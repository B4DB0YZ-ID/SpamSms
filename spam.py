...
\____/| .__/ \__,_|_| |_| |_| \____/|_| |_| |_|___/
	...
	def Spam():
		...
		if PilihTools == '1':
			...
			os.system('xdg-open http://wa.me/6285700925421?text=Hallo')
...
if __name__ == '__main__':
	print(C+'Follow IG'+W+' Gua Dlu Ya Su !'+C+' :V')
	sleep(2)
	os.system('clear')
	os.system('xdg-open https://www.instagram.com/sad.boyz01')
	sleep(7)
	Spam()